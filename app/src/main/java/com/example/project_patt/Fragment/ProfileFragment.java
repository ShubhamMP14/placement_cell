...
public class ProfileFragment extends Fragment {
    ...
    private void viewCV() {
        ...
        if (selectedFileUri != null) {
            // Retrieve the download URL of the selected file
...
// Handle failure
                            Toast.makeText(mContext, "Failed to retrieve CV: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
                    })
                    .addOnFailureListener(e -> {
// Handle failure
                        Toast.makeText(mContext, "CV upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        } else {
            Toast.makeText(mContext, "No CV uploaded", Toast.LENGTH_SHORT).show();
        }
    }
